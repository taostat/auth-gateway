        ...
        if (CONFIG.signMethod === 'evm') {
          ...
          if (extensions.length === 0) {
            ...
            if (walletInstalled) {
              ...
              let banner = document.getElementById(walletCfg.bannerId);
          ...
          if (polkaAccounts.length === 0) { showError('No accounts authorized. Open your wallet extension and allow access to at least one account.'); btn.disabled = false; btn.textContent = walletLabel; return; }
